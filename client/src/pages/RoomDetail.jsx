...
const RoomDetail = () => {
  ...
  useEffect(() => {
    const fetchRoom = async () => {
      ...
      setError("");
      try {
        const res = await apiFetch(`${import.meta.env.VITE_API_BASE_URL}/api/rooms/${id}`);
  ...
  return (
    <div className="min-h-[81vh] bg-white">
      <Navbar />
      <div className="bg-gray-100 md:py-7 px-4 pb-4 pt-22">
        <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-6 md:p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <DetailItem icon={<DollarSign />} label="Rent" value={`₹${room.rent}`} />
              ...
              <DetailItem icon={<Bed />} label="Rooms" value={`${room.rooms} Rooms`} />
              <DetailItem icon={<Home />} label="Furnishing" value={room.furnishing} />
              <DetailItem icon={<Users />} label="For Whom" value={room.forWhom} />
              <DetailItem icon={<Bed />} label="Type" value={room.independent} />
              <DetailItem icon={<Utensils />} label="Cooking" value={room.cooking} />
              <DetailItem icon={<Zap />} label="Electricity Bill" value={room.electricitybill} />
              <DetailItem icon={<Droplet />} label="Water Bill" value={room.waterbill} />
