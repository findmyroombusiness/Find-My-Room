...
const RoomList = () => {
  ...
  /* 🔧 FIXED INFINITE SCROLL (LOGIC ONLY) */
  useEffect(() => {
      ...
      apiFetch(
        ...
        .then(data => {
          ...
          setAllListings(prev => {
            ...
            const filtered = newListings.filter(
      ...
      <div className="min-h-[81vh] bg-gray-100 p-4 md:px-8 pt-20 md:pt-10">
        ...
        <div className="flex md:hidden flex-col gap-3 mb-6">
          ...
          <div className="flex gap-2">
            <button
              onClick={handleSortToggle}
              className={`flex-1 flex items-center justify-center gap-2 px-2 py-2 rounded-lg border border-gray-300 transition text-sm text-[rgb(77,95,171)] hover:bg-[rgb(77,95,171)] hover:text-white ${
                sortActive
                  ? "bg-[rgb(77,95,171)] text-white border-[rgb(77,95,171)]"
                  : ""
              }`}
